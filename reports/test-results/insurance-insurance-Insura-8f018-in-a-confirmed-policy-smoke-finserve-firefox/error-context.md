...
- Name: insurance\insurance.spec.js >> Insurance Purchase @insurance >> completing all mandatory fields results in a confirmed policy @smoke
- Location: tests\insurance\insurance.spec.js:22:3
