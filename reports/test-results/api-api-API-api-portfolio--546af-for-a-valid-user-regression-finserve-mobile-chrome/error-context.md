...
- Name: api\api.spec.js >> API @api >> portfolio endpoint requires authentication and returns holdings for a valid user @regression
- Location: tests\api\api.spec.js:51:3
