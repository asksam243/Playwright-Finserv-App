...
- Name: transactions\transactions.spec.js >> Transaction History @transactions >> filtering by transaction type returns only matching rows @regression
- Location: tests\transactions\transactions.spec.js:35:3
...
Call log:
  - Expect "not toHaveURL" with timeout 10000ms
    23 × unexpected value "http://34.93.84.32:8082/login"
