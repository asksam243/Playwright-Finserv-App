...
- Name: auth\login.spec.js >> Authentication @auth >> logged-in user can log out and loses access to protected routes @smoke
- Location: tests\auth\login.spec.js:36:3
