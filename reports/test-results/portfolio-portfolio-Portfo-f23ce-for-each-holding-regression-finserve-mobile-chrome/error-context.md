...
- Name: portfolio\portfolio.spec.js >> Portfolio Management @portfolio >> portfolio row shows current value and gain/loss for each holding @regression
- Location: tests\portfolio\portfolio.spec.js:26:3
